...
namespace MobVersion
{
    ...
    public class Authorization
    {
        ...
        public void Authorization_VKLogin_Positive()
        {
            ...
            vk.VKLoginTextBoxMobiput.SendKeys(TestDataResource.VKLogin);
            vk.VKLoginTextBoxMobpass.SendKeys(TestDataResource.VKPass);
    ...
    class MainPageTest
    {
        ...
        public void OtigrashBlock()
        {
            VuePage vue = new VuePage();
            vue.Auth(TestDataResource.GameUserTest, false);
            Driver.Browser.Url = TestDataResource.MainPageURL + "/?game=book-of-ra&isMoney=true";
        ...
        //    vue.Auth(TestDataResource.NewUserWithFS, false);
