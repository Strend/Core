...
namespace SlotokingNewDesktop
{
    class CashboxTest_V3
    {
...

        {
            ...
            replenish.Take1000Money.Click();
            replenish.CashboxPopupButtonpush.Click();
            replenish.CashboxPopupInputQiwi.SendKeys(TestDataResource.QiwiPhone);
            replenish.AgreePaymentsLast.Click();
        ...
        public void CashWithdrawal()
        {
            ...
            replenish.CashboxPopupInputSumma.SendKeys(TestDataResource.Payments);
            replenish.CashboxPopuprequisite.Clear();

            replenish.CashboxPopuprequisite.SendKeys(TestDataResource.CreditCardVisa);
