...
namespace Vulkan777
{
    class GamePage
    {
        ...
        public IWebElement GameProvaider => Driver.WaitUntilVisible(By.XPath("//*[@id='providerDropdownMenu']"));
        ...
        public IWebElement BalanceTextPartners => Driver.WaitUntilVisible(By.CssSelector("#vuePopup > div.modal.game > div > div.game__sidebar.show > div.game__sidebar-content > div > div.game__balance-container.balance.cs-1 > div.balance-value"));
        ...
        public IWebElement NovomaticButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(3) > a > div.dropdown-menu__text"));
        public IWebElement IgrosoftButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(2) > a > div.dropdown-menu__text"));
        public IWebElement Vulkan777 => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(4) > a > div.dropdown-menu__text"));
        public IWebElement EzugiButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(5) > a > div.dropdown-menu__text"));
        public IWebElement QuickspinButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(7) > a > div.dropdown-menu__text"));

        public IWebElement ElkButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(6) > a > div.dropdown-menu__text"));
        public IWebElement ThunderkickButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(8) > a > div.dropdown-menu__text"));
        public IWebElement SpinomenalButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(9) > a > div.dropdown-menu__text"));
        public IWebElement TomHornButton => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(10) > a > div.dropdown-menu__text"));
        public IWebElement BlueprintGaming => Driver.WaitUntilVisible(By.CssSelector("# providers-container > li:nth-child(11) > a > div.dropdown-menu__text"));
        ...
        public IWebElement Netgame => Driver.WaitUntilVisible(By.CssSelector("#providers-container > li:nth-child(13)"));
        ...
        public IWebElement PlayFirstGame => Driver.WaitUntilVisible(By.CssSelector("#games-container > div > div:nth-child(1) > div > div.game__content > div.game__play > svg > use"));




        public IWebElement Hover_SecondGame => Driver.WaitUntilVisible(By.CssSelector("#games-container > div > div:nth-child(2)"));
        public IWebElement PlaySecondGame => Driver.WaitUntilVisible(By.CssSelector("#games-container > div > div:nth-child(2) > div > div.game__content > a.game__play > img"));
        ...
        public IWebElement PlayThirdGame => Driver.WaitUntilVisible(By.CssSelector("#games-container > div > div:nth-child(3) > div > div.game__content > a.game__play > img"));
